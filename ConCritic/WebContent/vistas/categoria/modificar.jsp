...
%>
	  <form method="post">
            <div class="form-group">
              ...
              <input name="nombreCat" type="text" class="form-control" id="nombreCat" value=<%=catDTO.getNombre()%> readonly="readonly">
            </div> 
              <div class="form-group">
                <label for="descripcionCat">Descripción</label>
                <textarea name="descripcionCat" class="form-control" rows="5" id="descripcionCat" ><%=catDTO.getDescripcion()%></textarea>
              </div>
