			...
			<form method="post">
				<div class="form-group">
					<label for="tituloRev">Titulo</label> <input name="tituloRev" type="text"
						class="form-control" id="tituloRev" required="required">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<textarea name="comentarioRev" class="form-control" rows="5"
						id="comentarioRev" required="required"></textarea>
				</div>
...
<div class="container">
	...
	<%
		...
		int idItem = Integer.parseInt(request.getParameter("idItemReview"));
