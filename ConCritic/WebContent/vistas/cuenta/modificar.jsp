...
<div class="container">
<%Boolean errorActualizacionUsuario=(Boolean)request.getAttribute("errorActualizacionUsuario");
if(errorActualizacionUsuario==null)
	errorActualizacionUsuario=false;
if(errorActualizacionUsuario==true){
 %>
 <script type="text/javascript"> alert("error en la actualización del usuario")</script>
 <%
}
 %>
<%
UsuarioDTO usrModificar=(UsuarioDTO)request.getAttribute("usuarioModificar");
if(usrModificar==null)
	usrModificar=new UsuarioDTO();
%>
	<form method="post">
